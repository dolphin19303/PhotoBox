...
public abstract class AndroidTwitterLogin {
	...
	/**
	 * The message that is shown to the user before directing them off to
	 * Twitter. Default is "Please authorize with Twitter"
	 */
	...
	/**
	 * @param myActivity
	 *            This will have its conten view set, then reset.
	 * @param oauthAppKey
	 * @param oauthAppSecret
	 * @param calbackUrl
	 *            Not important
	 */
	public AndroidTwitterLogin(Activity myActivity, String oauthAppKey,
			String oauthAppSecret, String calbackUrl) {
		this.context = myActivity;
		consumerKey = oauthAppKey;
		consumerSecret = oauthAppSecret;
		this.callbackUrl = calbackUrl;
		client = new OAuthSignpostClient(consumerKey, consumerSecret,
				callbackUrl);
	}
	...
	public final void run() {
		...
		// getting the url to load involves a web call -- let the UI update
		// first
	...
	protected void onFail(Exception e) {
		Toast.makeText(context, "Twitter authorisation failed?!",
